...
function UserTransactions() {
    ...
    async function fetchUserTransactions() {
        ...
        const res = await fetch("https://cors-everywhere-me.herokuapp.com/http://18.170.116.112:6786/blockchain/user-transactions?userID=" + auth.getUserID(), { headers: { "Authorization": "Bearer " + token } });
        return res.json();
    }
