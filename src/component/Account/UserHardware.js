...
function UserHardware() {
    ...
    async function fetchHardware() {
        ...
        const res = await fetch("https://cors-everywhere-me.herokuapp.com/http://18.170.74.59:8080/api/user/hardware?username=" + username, { headers: { "Authorization": "Bearer " + token } });
        return res.json();
    }
